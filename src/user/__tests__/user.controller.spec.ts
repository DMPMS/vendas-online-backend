...
describe('UserController', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            findUserByIdUsingRelations: jest
              .fn()
  ...
  it('should return ReturnUser in findAllUser', async () => {
  ...
  it('should return ReturnUser in findUserById', async () => {
  ...
  it('should return ReturnUserEntity in getInfoUser', async () => {
    const user = await controller.findInfoUser(userEntityMock.id);
